...
public class TestXML {
        private static String[] empleadosNombres = {"Juan", "Alfonso", "Elisa", "Sergio", "Adolfo", "Germßn", "Carlos", "Alejandro"};
        private static String[] empleadosApellidos = {"Gonzalez", "Vico", "GarcÝa", "Palomo", "Coello", "Colmenarejo", "Lopez"};
        private static int contador = 0;
        public static void main(String[] args) throws JAXBException, IOException {
                Empleado e = new Empleado(1,"Sonia","Perez","1980-06-19",26000);
        ...
        private static void marshalling(Empleado emp) throws JAXBException {
                //Empleado emp1 = new Empleado(1, "Juan", "Perez", "1986-07-02", 28000);
                ...
                File XMLfile = new File("./xml/Equipo.xml");
                jaxbM.marshal(emp, XMLfile);
                // Escribiendo por pantalla
                //jaxbM.marshal(equipo, System.out);
        }
